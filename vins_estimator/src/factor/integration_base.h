...
class IntegrationBase
{
  public:
    ...
    //_acc_0、_gyr_0表示第k帧对应的IMU数据
    //_acc_1、_gyr_1表示第k->第k+1帧之间对应的IMU数据
    //函数作用是利用中值积分的方法(第k到k+1帧的IMU数据)，求出第k+1帧对应的Jaccobian和协方差矩阵
    //求出第k->第k+1帧之间某一时刻t对应的IMU数据相对于第k帧对应的IMU数据的pvq,
    ...
    {
        //参考：https://www.cnblogs.com/buxiaoyi/p/7353353.html
